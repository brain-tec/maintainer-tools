...
.. |badge1| image:: https://img.shields.io/badge/github-server--tools-lightgray.png?logo=github
    :target: https://github.com/OCA/server-tools/tree/12.0/addon_two_maintainers
...
.. |badge3| image:: https://img.shields.io/badge/runboat-Try%20me-875A7B.png
...
`feedback <https://github.com/OCA/server-tools/issues/new?body=module:%20addon_two_maintainers%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/server-tools <https://github.com/OCA/server-tools/tree/12.0/addon_two_maintainers>`_ project on GitHub.
